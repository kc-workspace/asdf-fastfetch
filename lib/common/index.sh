...
KC_ASDF_NAME="asdf-fastfetch"
KC_ASDF_REPO="https://github.com/kc-workspace/asdf-fastfetch"
export KC_ASDF_ORG KC_ASDF_NAME KC_ASDF_REPO

## Application information
KC_ASDF_APP_TYPE="standalone"
KC_ASDF_APP_NAME="fastfetch"
KC_ASDF_APP_WEBS="https://github.com/fastfetch-cli/fastfetch"
KC_ASDF_APP_DESC="A feature-rich and performance oriented, system information tool."
KC_ASDF_APP_CMDS="
- test    - test if cli exist and executable
- version - print *plugin* version
"
KC_ASDF_APP_REPO="https://github.com/fastfetch-cli/fastfetch"
